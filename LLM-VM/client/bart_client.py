...
class BartNLIClient:
    ...
    def batch_entailment_scores(
        ...
        # Optimize: Reduce context size and use smaller batch chunks
        # 1024 is overkill for simple entailment checks and is O(N^2) slow.
        # 128 tokens captures the core description + ingredients.
        MAX_LENGTH = 128  
        BATCH_SIZE = 16
        
        all_scores = []
        
        # Process in chunks to manage memory and padding efficiency
