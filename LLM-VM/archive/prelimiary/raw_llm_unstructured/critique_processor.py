...
def build_critique_prompt(itinerary, critique):
    ...
    """
    prompt = f"""You are a travel-planning assistant. Below is an existing travel itinerary and user feedback/critiques in pure text.

Your task:
1. Deal with the critique
2. Pass back the full Itinerary
