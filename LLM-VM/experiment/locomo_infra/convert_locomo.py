...
def main():
    # Project root is 3 levels up: locomo_infra -> experiment -> LLM-VM
    project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    # locomo_structured_data lives next to LLM-VM (in Struct_Memory_R1/)
    data_root = os.path.dirname(project_root)
    input_path = os.path.join(data_root, 'locomo_structured_data', 'locomo10.json')
    output_dir = os.path.join(data_root, 'locomo_structured_data')
